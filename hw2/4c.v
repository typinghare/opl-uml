...
| SSMod: forall n m s,
             (n > 0) % Z ->
            (EMod (EInt m) (EInt n), s) --> (EInt (Int_mod m n), s)
| SSLMod : forall e f g s t,
              (e, s) --> (f, t) ->
                (EMod e g, s) --> (EMod f g, t)
| SSRMod : forall n e f s t,
              (e, s) --> (f, t) ->
               (EMod (EInt n) e, s) --> (EMod (EInt n) f, t)
| SSEFact : forall e f s t, 
              (e , s) --> ( f , t) -> (EFact e, s) --> ( EFact f, t)
| SSVFact: forall n s,
